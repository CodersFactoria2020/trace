...
<div class="col">
    ...
    <div class="dashboard-right-side">
        ...
        <button type="button" class="cta" data-toggle="modal" data-target="#create-workplan"> Afegir un pla de
            treball</button>
    ...
    <div class="filter-views">
        ...
        <div class="float-right d-flex align-items-center">
            ...
            <div>
                <a href="{{ route('workplans.index', ['role_id' => request('role_id'), 'sort' => 'asc']) }}"
                    class="btn btn-outline-dark btn-sm active">Ascendent</a>
                <a href="{{ route('workplans.index', ['role_id' => request('role_id'), 'sort' => 'desc']) }}"
                    class="btn btn-outline-dark btn-sm">Descendent</a>
            </div>
            ...
            <tr>
                <td class="icon-text">
                    <div class="primary-green">
                        <a href="" data-toggle="modal" data-target="#show-workplan{{$user->id}}" class="primary-green"
                            user="button">
                ...
                <td class="actions">
                    ...
                    <div class="primary">
                        <a href="" data-toggle="modal" data-target="#edit-workplan{{$user->id}}" class="primary-green"
                            user="button">
