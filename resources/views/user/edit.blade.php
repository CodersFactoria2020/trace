                    ...
                    <form action="{{Route('user.update', $user->id)}}" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="first_name" class="form-control" value="{{$user->first_name}}" pattern="[A-Za-z].{1,}" required/>
                            ...
                            <div class="form-group col-md-6">
                                <label>Cognom</label>
                                <input type="text" name="last_name" class="form-control" value="{{$user->last_name}}" pattern="[A-Za-z].{1,}" required/>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>Email</label>
                                <input type="text" name="email" class="form-control" value="{{$user->email}}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required/>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Telèfon</label>
                                <input type="text" name="phone" class="form-control" value="{{$user->phone}}" required pattern="[0-9].{6,}"/>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Tutor(a)</label>
                                <input type="text" name="tutor" class="form-control" value="{{$user->tutor}}" pattern="[A-Za-z]"/>
                            </div>
                            <div class="invalid-feedback">
